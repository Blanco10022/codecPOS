...
import { Search, FileDown, Plus, Pencil, Trash2, ArrowLeft } from "lucide-react"
...
const stockMovementsData: StockMovement[] = [
  { id: 1, type: "Added", quantity: 100, date: "2023-06-01", movementType: "Inbound", reason: "Restocking", performedBy: "John Doe" },
  { id: 2, type: "Sold", quantity: 50, date: "2023-06-02", movementType: "Outbound", reason: "Customer Purchase", performedBy: "Jane Smith" },
  { id: 3, type: "Returned", quantity: 10, date: "2023-06-03", movementType: "Inbound", reason: "Defective Product", performedBy: "Mike Johnson" },
  { id: 4, type: "Adjustment", quantity: -5, date: "2023-06-04", movementType: "Outbound", reason: "Inventory Count", performedBy: "Sarah Brown" },
  { id: 5, type: "Added", quantity: 200, date: "2023-06-05", movementType: "Inbound", reason: "New Stock", performedBy: "John Doe" },
]

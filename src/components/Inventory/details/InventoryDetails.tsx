            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="sku" name="sku" value={itemState.sku} onChange={handleInputChange} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="name">Name</Label>
                  <Input id="name" name="name" value={itemState.name} onChange={handleInputChange} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="category">Category</Label>
                  <Select value={itemState.category} onValueChange={(value) => setItemState(prevItem => ({ ...prevItem, category: value }))}>
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="supplier" name="supplier" value={itemState.supplier} onChange={handleInputChange} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="unitPrice">Unit Price (XAF)</Label>
                  <Input id="unitPrice" name="unitPrice" type="number" value={itemState.unitPrice} onChange={handleInputChange} />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="description" name="description" value={itemState.description} onChange={handleInputChange} />
              </div>
            </CardContent>
          </Card>
        </TabsContent>
